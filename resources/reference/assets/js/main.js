...
function getNavSections(activeHref) {
  const sections = [
    ...
    { label: 'Management', items: [
      ...
      { name: 'Payroll',     href: 'payroll.html',    icon: 'M12 8c-1.11 0-2 .89-2 2s.89 2 2 2 2 .89 2 2-.89 2-2 2m0-8c1.11 0 2 .89 2 2m-2-2V6m0 12v-2m0-8c-1.11 0-2 .89-2 2M12 4a8 8 0 100 16 8 8 0 000-16z' },
